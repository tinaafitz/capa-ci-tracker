...
function FunnelStageCard({ stage, index, maxCount, firstCount }) {
  ...
  return (
    <Tooltip delayDuration={100}>
      <TooltipTrigger
        render={
          <div className={`flex flex-col items-center flex-1 min-w-0 group cursor-default`}>
            {/* Count + label header */}
...
function ConversionConnector() {
  return (
    <div className="flex items-center justify-center shrink-0 pt-6" style={{ width: '24px' }}>
      {/* Chevron arrow */}
...
export function PipelineFunnel({ data, loading }) {
  if (loading) {
    return (
      <Card>
